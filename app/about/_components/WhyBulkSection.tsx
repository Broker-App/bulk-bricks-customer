...
const ROWS = [
  {
    ...
    body: 'When buyers pool together, builders take notice. A group of 20 committed buyers has far more negotiating power than 20 individuals approaching separately. Builders offer group-exclusive pricing, flexible payment timelines, and early booking privileges to secure guaranteed volume.',
  ...
  },
  {
    ...
    body: "Every unlocked property gives you entry into the builder's own WhatsApp group. You ask questions, get construction updates, and negotiate in real time — directly with the people building your home. No agent translating, filtering, or incentivised to mislead.",
  ...
  },
  {
    ...
    body: "The price you see is the builder's group rate — not a retail markup. Our model charges you a single flat access fee, not a percentage of your property value. You know exactly what you're paying and exactly what you get in return.",
